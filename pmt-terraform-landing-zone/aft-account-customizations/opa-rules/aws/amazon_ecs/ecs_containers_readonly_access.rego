...
# The rule is NON_COMPLIANT if the readonlyRootFilesystem parameter in the container definition of ECSTaskDefinitions is set to ‘false’.
#
# Resource Types:
#    ecs_task_definition
#
...
violations[response] {
	...
	object.get(container_definitions[_], "readonlyRootFilesystem", false) == false
	...
	response := terraform.ocsf_response(id, title, {
		"message": {
			...
			"OWNER": owner,
			"SEVERITY": level,
			"DESCRIPTION": "Resource ECS Container should be given read-only access to its root file system. https://docs.aws.amazon.com/config/latest/developerguide/ecs-containers-nonprivileged.html",
		},
