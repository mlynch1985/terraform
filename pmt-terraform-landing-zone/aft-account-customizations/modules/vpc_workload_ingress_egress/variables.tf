...
variable "region" {
  description = "Provide the target region name"
  type        = string
}
...
variable "tgw_rtb_inspection_name" {
  description = "Provide the value used on the Name Tag of the Inspection TGW Route Table"
  type        = string
  default     = ""
}
