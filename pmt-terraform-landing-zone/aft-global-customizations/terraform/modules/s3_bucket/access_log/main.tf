...
resource "aws_s3_bucket" "access_logs" {
  ...
  # S3-7 - Skipping OPA check for s3 bucket server encryption as it is a false positive
  # S3-9 - Skipping OPA check for s3 bucket versioning as it is a false positive
  # S3-3 - Skipping OPA check for s3 default kms encryption as it is not supported for access logs, see below link
  # https://docs.aws.amazon.com/elasticloadbalancing/latest/application/enable-access-logging.html
  tags = {
    "opa_skip" = "S3-2/S3-3/S3-10/S3-12/S3-15/S3-7/S3-9"
  }
}
