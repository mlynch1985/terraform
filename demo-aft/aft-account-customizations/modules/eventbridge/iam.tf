...
data "aws_iam_policy_document" "sns" {
  ...
  #checkov:skip=CKV_AWS_111:SNS Publish is constranint to variable "sns_target_arns"
  #checkov:skip=CKV_AWS_356:KMS arn is not known at the time of this setup
...
data "aws_iam_policy_document" "ecs" {
  ...
  #checkov:skip=CKV_AWS_109:ECS RunTask is constranint to variable "ecs_target_arns"
  #checkov:skip=CKV_AWS_356:Resource arn is not known at the time of this setup
