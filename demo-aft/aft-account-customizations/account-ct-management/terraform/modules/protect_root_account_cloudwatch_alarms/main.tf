...
# Enable Control Tower SNS Topic
module "deploy_control_tower_sns_topic" {
  source = "./modules/deploy_control_tower_sns_topic"
}
...
# A CloudWatch Alarm that triggers if Multiple unauthorized actions or logins attempted.
...
# A CloudWatch Alarm that triggers when changes are made to IAM policies. Events include IAM policy creation/deletion/update operations as well as attaching/detaching policies from IAM users, roles or groups."
module "iam_assumerole_circleci_cloudwatch_alarm" {
  source = "./modules/cloudwatch_alarm"

  period            = 300
  metric_name       = "IAMAssumeRoleCircleCIEventCount"
  metric_namespace  = "CloudTrailMetrics"
  alarm_description = "A CloudWatch Alarm that triggers if AssumeRole is performed to AutomationServiceRoleForCircleCI Role."
  log_group_name    = "aws-controltower/CloudTrailLogs"
  filter_pattern    = "{($.eventName=AssumeRole) && ($.requestParameters.roleArn=%AutomationServiceRoleForCircleCI%)}"
  alarm_actions     = []
...
# # Cloud HSM Samples
# # A CloudWatch Alarm that triggers when Cloud HSM Login failures occur due to bad password.
# module "hsm_login_failure_due_to_bad_password_cloudwatch_alarm" {
#   source = "./modules/cloudwatch_alarm"

#   period            = 300
#   metric_name       = "HSMBadPasswordEventCount"
#   metric_namespace  = "HSMEventBadPassword"
#   alarm_description = "This metric monitors logins with correct usernames but wrong passwords"
#   log_group_name    = "aws-controltower/CloudTrailLogs"         // need to update the log group name with the Cloud HSM log group
#   filter_pattern    = "RET_USER_LOGIN_FAILURE"
#   alarm_actions     = []
...
# # Cloud HSM Samples
# # A CloudWatch Alarm that triggers when Cloud HSM Login failures occur due to wrong username.
# module "hsm_login_failure_due_to_wrong_username_cloudwatch_alarm" {
#   source = "./modules/cloudwatch_alarm"

#   period            = 300
#   metric_name       = "HSMWrongUsernameEventCount"
#   metric_namespace  = "HSMEventWrongUsername"
#   alarm_description = "This metric monitors logins with incorrect usernames."
#   log_group_name    = "aws-controltower/CloudTrailLogs"         // need to update the log group name with the Cloud HSM log group
#   filter_pattern    = "\"Error: This user doesn't exist\""
#   alarm_actions     = []
...
# # Cloud HSM Samples
# # A CloudWatch Alarm that triggers when new user is created in Cloud HSM
# module "hsm_new_user_creation_cloudwatch_alarm" {
#   source = "./modules/cloudwatch_alarm"

#   period            = 300
#   metric_name       = "HSMUserCreatedEventCount"
#   metric_namespace  = "HSMEventsUserCreated"
#   alarm_description = "New crypto user created"
#   log_group_name    = "aws-controltower/CloudTrailLogs"         // need to update the log group name with the Cloud HSM log group
#   filter_pattern    = "CN_CREATE_USER"
#   alarm_actions     = []
...
# # Cloud HSM Samples
# # A CloudWatch Alarm that triggers when new crypto officer is created in Cloud HSM
# module "hsm_new_crypto_officer_creation_cloudwatch_alarm" {
#   source = "./modules/cloudwatch_alarm"

#   period            = 300
#   metric_name       = "HSMNewCryptoOfficerEventCount"
#   metric_namespace  = "HSMEventsNewCryptoOfficer"
#   alarm_description = "New Crypto Officer Created"
#   log_group_name    = "aws-controltower/CloudTrailLogs"         // need to update the log group name with the Cloud HSM log group
#   filter_pattern    = "CN_CREATE_CO"
#   alarm_actions     = []
...
# # Cloud HSM Samples
# # A CloudWatch Alarm that triggers when new appliance user is created in Cloud HSM
# module "hsm_new_appliance_user_creation_cloudwatch_alarm" {
#   source = "./modules/cloudwatch_alarm"

#   period            = 300
#   metric_name       = "HSMNewApplianceOfficerEventCount"
#   metric_namespace  = "HSMEventsNewApplianceOfficer"
#   alarm_description = "New Appliance User Created"
#   log_group_name    = "aws-controltower/CloudTrailLogs"         // need to update the log group name with the Cloud HSM log group
#   filter_pattern    = "CN_CREATE_APPLIANCE_USER"
#   alarm_actions     = []
